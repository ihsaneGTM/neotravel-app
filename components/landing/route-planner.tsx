  ...
  return (
    <form className="lp-planner" onSubmit={submit}>
      ...
      <div className="lp-planner-head">
        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden focusable="false">
        ...
        {stops.map((s, i) => (
          <div key={i}>
            ...
            <div className="lp-field">
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" aria-hidden focusable="false">
      ...
      {stops.length < 4 && (
        <button type="button" className="lp-add-stop" onClick={() => setStops([...stops, ""])}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" aria-hidden focusable="false">
      ...
      <button type="submit" className="ap-btn ap-btn-blue lp-planner-cta" disabled={!canSubmit}>
        Démarrer ma demande
